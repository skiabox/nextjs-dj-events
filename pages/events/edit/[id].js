...
export default function EditEventPage({ evt, token }) {
  //use useState hook for the whole form object
  ...
  const handleSubmit = async (e) => {
    ...
    //create a response object using fetch and strapi
  ...
  const handleInputChange = (e) => {
    //name could be name, venue, performers etc
...
//the cookie is located at the req object
